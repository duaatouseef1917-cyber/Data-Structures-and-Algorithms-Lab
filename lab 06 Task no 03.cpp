...
int main(){
    ...
    list.addBook("B1","DS",500,"Touseef","111");
    list.addBook("B2","OOP",600,"Ahmed","222");
    list.addBook("B3","DB",700,"Duaa","333");
    list.addBook("B4","OS",800,"Abid","444");
    list.addBook("B5","AI",900,"Babar","555");
    list.addBook("B6","ML",650,"Mirha","666");
    list.addBook("B7","CN",550,"Bushra","777");
    list.addBook("B8","SE",750,"Aamir","888");
    list.addBook("B9","Algo",850,"Tipu","999");
    list.addBook("B10","Math",400,"Hania","1000");
    ...
    list.updateBook("B3","Database",750,"Duaa","333");
    list.printBook("B3");
